 ...
 * event/completion builtins + kl_resolve_sync + kl_sockdef_accept). The DATAGRAM path (udp.c)
 ...
 *
 * kl_sockdef_accept is NOT here: it moved to u1_link_stubs.c (7a4bea5), which this 6.4c build
 * ALSO links — defining it here too would duplicate it. The S-4/S-7 servers get accept from

#!/usr/bin/env bash
# build_s4.sh — build the S-4 KlHttpServer-over-EFI_TCP4 self-test into BOOTX64.EFI.
#
...
SRCS=( ../allocator_uefi.c ../errno_uefi.c ../platform_uefi.c ../civil_time.c ../wallclock_uefi.c
       ../socket_efi_tcp4.c ../event_efi.c u1_link_stubs.c s4_link_stubs.c s4_selftest.c )
OBJS=()
for s in "${SRCS[@]}"; do
  o="$(basename "${s%.c}").obj"
  echo "compiling $s ..."

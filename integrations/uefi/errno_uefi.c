 ...
 *
 * The EFI socket provider (socket_efi_tcp4.c, U-6) WRITES errno = EAGAIN on a would-block
 ...
 * provider — including U-2, which links the provider but not the heavier u1_link_stubs.c.

 ...
 *
 * kl_response_send() serializes a buffered response (status line + headers +
 ...
 */
#ifndef KEEL_SRC_RESPONSE_INTERNAL_H
#define KEEL_SRC_RESPONSE_INTERNAL_H

#include <keel/response.h>
#include <keel/socket.h>   /* KlIoVec */
#include <stddef.h>

/* Assemble the full wire bytes of a buffered response (KL_BODY_BUFFER/KL_BODY_NONE)
